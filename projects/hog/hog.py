...
def is_swap(player_score, opponent_score):
    ...
    opponent_ten_digit = (opponent_score - (opponent_score // 100) * 100) // 10
    if abs(player_one_digit - opponent_one_digit) == opponent_ten_digit:
        return True
    return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and  score1 < goal:
        ...
        if(who == 0):
            ...
            cur_score = take_turn(num_rolls_0,score1,dice)
            score0 += cur_score
            if feral_hogs == True and abs(last_score0 - num_rolls_0) == 2:
                score0 += 3
            if(is_swap(score0,score1)):
                if_swap = True
            last_score0 = cur_score
        else:
            num_rolls_1 = strategy1(score1,score0) 
            cur_score = take_turn(num_rolls_1,score0,dice)
            score1 += cur_score
            if feral_hogs == True and abs(last_score1 - num_rolls_1) == 2:
                score1 += 3
            if(is_swap(score1,score0)):
                if_swap = True
            last_score1 = cur_score
        if(if_swap == True):
            tmp = score0
            score0 = score1
            score1 = tmp
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say_highest(score0, score1):
        ...
        if who == 0:
            ...
            if score > running_h:
                running_h = score
                print(score,"point(s)! That's the biggest gain yet for Player 0")
            return announce_highest(who,score0,running_h)
        else:
            score = score1 - last_score
            if score > running_h:
                running_h = score
                print(score,"point(s)! That's the biggest gain yet for Player 1")
            return announce_highest(who,score1,running_h)
    return say_highest
    # END PROBLEM 7
