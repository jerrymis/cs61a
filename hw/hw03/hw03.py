...
def g_iter(n):
    ...
    if n <= 3:
        ...
        for i in range(4,n+1):
            result = g_pre1 + 2 * g_pre2 + 3 * g_pre3
            g_pre3 = g_pre2
            g_pre2 = g_pre1
            g_pre1 = result
    return result
...
def count_change(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    def func_helper(total_num,small_coin):
        if total_num == small_coin:
            return 1
        elif total_num < small_coin:
            return 0
        elif total_num >= 2 * small_coin:
            return func_helper(total_num-small_coin,small_coin)  + func_helper(total_num ,2 * small_coin) 
        else:
            return func_helper(total_num-small_coin,small_coin)

    return func_helper(total,1)
